-- Script de migración seguro que evita conflictos
-- Este script elimina políticas existentes antes de crear nuevas
...
drop policy if exists "bands_insert_member" on public.bands;
drop policy if exists "bands_update_member" on public.bands;
drop policy if exists "bands_delete_owner" on public.bands;

-- User bands
drop policy if exists "user_bands_select_all" on public.user_bands;
drop policy if exists "user_bands_insert_owner" on public.user_bands;
drop policy if exists "user_bands_update_owner" on public.user_bands;
drop policy if exists "user_bands_delete_owner" on public.user_bands;
...
create policy "bands_delete_all" on public.bands for delete using (true);
...
create policy "user_bands_update_all" on public.user_bands for update using (true);
create policy "user_bands_delete_all" on public.user_bands for delete using (true);
...
create policy "band_followers_delete_all" on public.band_followers for delete using (true);
...
create policy "user_activity_update_all" on public.user_activity for update using (true);
create policy "user_activity_delete_all" on public.user_activity for delete using (true);
...
create policy "user_preferences_update_all" on public.user_preferences for update using (true);
create policy "user_preferences_delete_all" on public.user_preferences for delete using (true);
